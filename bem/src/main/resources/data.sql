...
insert into hotel(city, name, address, zip) values (1, 'Marriott', 'Center Streets', '4003');
insert into hotel(city, name, address, zip) values (1, 'Four Seasons', '101 Streets', '4009');
