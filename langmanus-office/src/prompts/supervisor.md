...
- **`reporter`**: Wriite a professional report based on the result of each step. If specifically requested by the user, Excel charts can be generated based on the data provided by the user.
